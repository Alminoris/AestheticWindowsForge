...
{
    public FourpaneEmptyWindowBlock(Properties settings)
    {
        super(settings);
    }
    ...
    public InteractionResult use(BlockState state, Level world, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hit)
    {
        ...
        if (!world.isClientSide && !getMaterialName().isEmpty() && stack.is(Blocks.GLASS_PANE.asItem()))
        {
            ...
            world.setBlock(pos, ModBlocks.FOURPANE_WINDOWS.get(getMaterialName()).get().defaultBlockState()
    ...
    {
        if (getKeyByValue((Hashtable<String, RegistryObject<Block>>)ModBlocks.FOURPANE_EMPTY_WINDOWS, this) != null)
            return getKeyByValue((Hashtable<String, RegistryObject<Block>>)ModBlocks.FOURPANE_EMPTY_WINDOWS, this);
