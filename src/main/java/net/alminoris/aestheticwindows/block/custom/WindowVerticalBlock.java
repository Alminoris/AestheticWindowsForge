...
{
    public WindowVerticalBlock(Properties settings)
    {
        super(settings);
    }
    ...
    public void destroy(LevelAccessor world, BlockPos pos, BlockState state)
    {
        ...
        {
            world.setBlock(pos, ModBlocks.VERTICAL_EMPTY_WINDOWS.get(getMaterialName()).get().defaultBlockState()
    ...
    {
        if (getKeyByValue((Hashtable<String, RegistryObject<Block>>)ModBlocks.VERTICAL_WINDOWS, this) != null)
            return getKeyByValue((Hashtable<String, RegistryObject<Block>>)ModBlocks.VERTICAL_WINDOWS, this);
